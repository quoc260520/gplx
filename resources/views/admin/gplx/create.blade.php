...
@section('content')
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="#">Thêm giấy phép lái xe</a>
                <!-- Navigation links -->
            </div>
        </nav>
        <div class="container my-5">
            <div class="row">
                <div class="row">
                    ...
                    <form method="POST" action="{{ route('post.gplx.create') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="kind" id="kind">
                                        @foreach ($drivingLicenseKind as $key => $kind)
                                            <option value="{{ $kind }}" {{ old('kind') == $kind ? 'select' : '' }}>
                                                {{ $kind }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="driving_licenses_code"
                                        ...
                                        value="{{ old('driving_licenses_code') ?? $codeRandom }}">
