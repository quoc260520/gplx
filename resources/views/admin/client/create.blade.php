...
@section('content')
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="#">Thêm khách hàng</a>
                <!-- Navigation links -->
            </div>
        </nav>
        <div class="container my-5">
            <div class="row">
                <div class="row">
                    ...
                    <form method="POST" action="{{ route('post.client.create') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-8 border-end">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone"
                                        pattern="[0-9.]+" maxlength="11" value="{{ old('phone') ?? '' }}">
                                    @if ($errors->has('phone'))
                                        <div class="mes-feedback">
                                            {{ $errors->first('phone') }}
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    <img src="{{ asset('/dist/img/avatar.png') }}" class="rounded mx-auto d-block"
                                        alt="avatar" id="avatar_pre">
                                </div>
                                <div class="mb-3">
