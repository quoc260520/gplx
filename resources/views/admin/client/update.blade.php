...
@section('content')
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="#">Cập nhật khách hàng</a>
                <!-- Navigation links -->
            </div>
        </nav>
        <div class="container my-5">
            <div class="row">
                <div class="row">
                    ...
                    <form method="POST" action="{{ route('post.client.update', ['id' => $client->id]) }}"
                        ...
                        <div class="row">
                            <div class="col-lg-8 border-end">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="position_code" name="position_code"
                                        value="{{ old('position_code') ? old('position_code') : $client->position_code ?? '' }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="cccd" name="cccd" pattern="\d*"
                                        maxlength="12" value="{{ old('cccd') ? old('cccd') : $client->cccd ?? '' }}">
                                    @if ($errors->has('cccd'))
                                        <div class="mes-feedback">
                                            {{ $errors->first('cccd') }}
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    <img src="{{ $client->image ? asset('storage/avatar/' . $client->image) : asset('/dist/img/avatar.png') }}"
