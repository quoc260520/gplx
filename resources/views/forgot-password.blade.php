        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card">
                <div class="card-header text-center">
                    <h3 class="font-weight-bold">Quên Mật Khẩu</h3>
                </div>
                <div class="card-body">
                    <form accept="{{ route('post.forgot') }}" enctype="multipart/form-data" method="post">
                        @csrf
                        ...
                        <div class="text-center">
                            <div class="form-group">
                                <input type="submit" value="Quên Mật Khẩu" class="btn login_btn">
                            </div>
                        </div>
                        <div class="login" id='login'>Đăng Nhập</div>
                    </form>
                </div>
            </div>
        </div>
